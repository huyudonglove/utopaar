  ...
  <div v-if="rolePower.length">
    <div v-if="$route.name=='roleList'">
      <div style="height:50px;border-bottom:1px solid #DFDCDC;">
        ...
        <el-button :disabled="!rolePower[0].isCheck" style="float:right;" type="primary" @click="$router.push({path:'/system/rolelist/createrole',query:{oldQuery:JSON.stringify($route.query)}})">新增</el-button>
      </div>
      <el-row class="tac" style="border-bottom:1px solid #eeeeee; padding:15px 0;">
        ...
        <el-button type="danger" @click="del"  :disabled="!rolePower[3].isCheck">批量删除</el-button>
      </el-row>
      <el-table ref="roleRef" :data="userTable" border style="width: 100%" class="mt15 mb15" @selection-change="handleSelectionChange" :max-height="tableHeight">
        ...
        <el-table-column prop="roleCode" label="类型" align="center"></el-table-column>
        <el-table-column prop="description" label="备注" align="center"></el-table-column>
        <el-table-column label="操作" fixed="right" width="100" align="center">
          <template slot-scope="scope">
            <el-button :disabled="!rolePower[1].isCheck" type="primary" size="mini" @click="$router.push({path:'/system/rolelist/createrole',query:{id:scope.row.id,oldQuery:JSON.stringify($route.query)}})">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div>
