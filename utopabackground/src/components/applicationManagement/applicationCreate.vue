     ...
     <el-row class="tac" style="border-bottom:1px solid #eeeeee; padding:15px 0;" >
        ...
        <el-table-column prop="isLyric" label="是否包含歌词" width="80" align="center" v-if="tagKey==101||tagKey==110" :key="38">
          ...
          <el-table-column  label="Android资源包大小" width="150" align="center" v-if="tagKey ==101||tagKey ==102||tagKey ==103" prop="androidResourcePackageSize" :key="40" sortable >
           ...
           <el-table-column prop="iosResourcePackageSize" label="IOS资源包大小" width="140" align="center" v-if="tagKey ==101&&!equipmentEyeglass||tagKey ==102&&!equipmentEyeglass||tagKey ==103&&!equipmentEyeglass||tagKey ==105&&!equipmentEyeglass||tagKey ==106&&!equipmentEyeglass" :key="41" sortable="custom">
              <template slot-scope="scope">
                {{((scope.row.iosResourcePackageSize/(1024*1024))+'').slice(0,4)}}M
              </template>
            </el-table-column>
